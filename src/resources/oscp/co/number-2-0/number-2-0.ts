...
export class Number2_0 extends APIResource {
  ...
  handshake(params: Number2_0HandshakeParams, options?: RequestOptions): APIPromise<void> {
    const {
  ...
  updateAssetMeasurements(
    params: Number2_0UpdateAssetMeasurementsParams,
  ...
  updateGroupCapacityForecast(
    params: Number2_0UpdateGroupCapacityForecastParams,
    options?: RequestOptions,
  ): APIPromise<void> {
    const {
      'X-Request-ID': xRequestID,
...
export interface Number2_0HandshakeParams {
  /**
   * Header param:
   */
  'X-Request-ID': string;
...
export interface Number2_0UpdateAssetMeasurementsParams {
  /**
   * Body param:
   */
  group_id: string;
   ...
   * Body param:
   */
  measurements: Array<Number2_0UpdateAssetMeasurementsParams.Measurement>;
...
export namespace Number2_0UpdateAssetMeasurementsParams {
...
export interface Number2_0UpdateGroupCapacityForecastParams {
  /**
   * Body param:
   */
  forecasted_blocks: Array<Number2_0UpdateGroupCapacityForecastParams.ForecastedBlock>;
...
export namespace Number2_0UpdateGroupCapacityForecastParams {
