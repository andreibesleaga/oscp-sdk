...
export class Number2_0 extends APIResource {
  ...
  handshake(params: Number2_0HandshakeParams, options?: RequestOptions): APIPromise<void> {
    ...
    return this._client.post('/oscp/fp/2.0/handshake', {
      body,
      ...options,
  ...
  handshakeAcknowledge(
    ...
    return this._client.post('/oscp/fp/2.0/handshake_acknowledge', {
      body,
      ...options,
      headers: buildHeaders([
        {
  ...
  heartbeat(params: Number2_0HeartbeatParams, options?: RequestOptions): APIPromise<void> {
    ...
    return this._client.post('/oscp/fp/2.0/heartbeat', {
      body,
      ...options,
      headers: buildHeaders([
        {
  ...
  updateGroupCapacityForecast(
    ...
    return this._client.post('/oscp/fp/2.0/update_group_capacity_forecast', {
      body,
      ...options,
      headers: buildHeaders([
        {
