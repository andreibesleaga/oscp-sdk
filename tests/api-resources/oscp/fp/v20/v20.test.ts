...
describe('resource v20', () => {
  ...
  test.skip('handshake: only required params', async () => {
    const responsePromise = client.oscp.fp.v20.handshake({ 'X-Request-ID': 'X-Request-ID' });
  ...
  test.skip('handshake: required and optional params', async () => {
    const response = await client.oscp.fp.v20.handshake({
  ...
  test.skip('handshakeAcknowledge: only required params', async () => {
    const responsePromise = client.oscp.fp.v20.handshakeAcknowledge({ 'X-Request-ID': 'X-Request-ID' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('handshakeAcknowledge: required and optional params', async () => {
    const response = await client.oscp.fp.v20.handshakeAcknowledge({
      'X-Request-ID': 'X-Request-ID',
      heartbeat_interval: 0,
      measurement_configuration: ['CONTINUOUS'],
      'X-Correlation-ID': 'X-Correlation-ID',
  ...
  test.skip('heartbeat: only required params', async () => {
    const responsePromise = client.oscp.fp.v20.heartbeat({ 'X-Request-ID': 'X-Request-ID' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('heartbeat: required and optional params', async () => {
    const response = await client.oscp.fp.v20.heartbeat({
      'X-Request-ID': 'X-Request-ID',
  ...
  test.skip('updateGroupCapacityForecast: only required params', async () => {
    const responsePromise = client.oscp.fp.v20.updateGroupCapacityForecast({
      forecasted_blocks: [
        {
          capacity: 'capacity',
  ...
  test.skip('updateGroupCapacityForecast: required and optional params', async () => {
    const response = await client.oscp.fp.v20.updateGroupCapacityForecast({
      forecasted_blocks: [
        {
          capacity: 'capacity',
          end_time: '2019-12-27T18:11:19.117Z',
