...
describe('resource number2_0', () => {
  ...
  test.skip('handshake: only required params', async () => {
    const responsePromise = client.oscp.co.number2_0.handshake({ 'X-Request-ID': 'X-Request-ID' });
  ...
  test.skip('handshake: required and optional params', async () => {
    const response = await client.oscp.co.number2_0.handshake({
  ...
  test.skip('heartbeat: only required params', async () => {
    const responsePromise = client.oscp.co.number2_0.heartbeat({ 'X-Request-ID': 'X-Request-ID' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('heartbeat: required and optional params', async () => {
    const response = await client.oscp.co.number2_0.heartbeat({
      'X-Request-ID': 'X-Request-ID',
  ...
  test.skip('updateAssetMeasurements: only required params', async () => {
    const responsePromise = client.oscp.co.number2_0.updateAssetMeasurements({
      group_id: 'group_id',
  ...
  test.skip('updateAssetMeasurements: required and optional params', async () => {
    const response = await client.oscp.co.number2_0.updateAssetMeasurements({
      group_id: 'group_id',
      measurements: [
        {
  ...
  test.skip('updateGroupCapacityForecast: only required params', async () => {
    const responsePromise = client.oscp.co.number2_0.updateGroupCapacityForecast({
      forecasted_blocks: [
        {
          capacity: 'capacity',
  ...
  test.skip('updateGroupCapacityForecast: required and optional params', async () => {
    const response = await client.oscp.co.number2_0.updateGroupCapacityForecast({
      forecasted_blocks: [
        {
          capacity: 'capacity',
          end_time: '2019-12-27T18:11:19.117Z',
