...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/oscp/fp/2.0/update_group_capacity_forecast',
  operationId: 'updateGroupCapacityForecastFlexibilityProvider',
};

export const tool: Tool = {
  name: 'update_group_capacity_forecast_fp_oscp_number_2_0',
  description:
...
export const handler = async (client: Oscp, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.oscp.fp.number2_0.updateGroupCapacityForecast(body).asResponse();
