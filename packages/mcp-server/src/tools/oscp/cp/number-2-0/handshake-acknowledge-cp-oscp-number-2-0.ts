...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/oscp/cp/2.0/handshake_acknowledge',
  operationId: 'handshakeAcknowledgeCapacityProvider',
};

export const tool: Tool = {
  name: 'handshake_acknowledge_cp_oscp_number_2_0',
  description:
...
export const handler = async (client: Oscp, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.oscp.cp.number2_0.handshakeAcknowledge(body).asResponse();
