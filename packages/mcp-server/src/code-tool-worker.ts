...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Oscp)`
    : `const run: (${functionSource.client}: Oscp) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.oscp.fp.v20.handshake',
    'client.oscp.fp.v20.handshakeAcknowledge',
    'client.oscp.fp.v20.heartbeat',
    'client.oscp.fp.v20.updateGroupCapacityForecast',
    'client.oscp.fp.v20.register.create',
    'client.oscp.fp.v20.register.delete',
    'client.oscp.fp.v20.register.update',
    'client.oscp.cp.v20.adjustGroupCapacityForecast',
    'client.oscp.cp.v20.groupCapacityComplianceError',
    'client.oscp.cp.v20.handshakeAcknowledge',
    'client.oscp.cp.v20.heartbeat',
    'client.oscp.cp.v20.updateGroupMeasurements',
    'client.oscp.cp.v20.register.create',
    'client.oscp.cp.v20.register.delete',
    'client.oscp.cp.v20.register.update',
    'client.oscp.co.v20.handshake',
    'client.oscp.co.v20.heartbeat',
    'client.oscp.co.v20.updateAssetMeasurements',
    'client.oscp.co.v20.updateGroupCapacityForecast',
    'client.oscp.co.v20.register.create',
    'client.oscp.co.v20.register.delete',
    'client.oscp.co.v20.register.update',
  ],
