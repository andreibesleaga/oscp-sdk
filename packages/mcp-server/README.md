...
[Open VS Code](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22oscp-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22oscp-mcp%22%5D%2C%22env%22%3A%7B%22OSCP_API_KEY%22%3A%22Set%20your%20OSCP_API_KEY%20here.%22%7D%7D)
...
```
claude mcp add --transport stdio oscp_sdk_api --env OSCP_API_KEY="Your OSCP_API_KEY here." -- npx -y oscp-mcp
```
